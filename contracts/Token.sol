/**
 * Based on USDT https://etherscan.io/address/0xdac17f958d2ee523a2206206994597c13d831ec7#code
 * And FundingRules based on https://github.com/thundercore/thunder_bridge/blob/master/contracts/contracts/ERC677BridgeToken.sol
*/
...
/*
// Everything above this line is copied directly from https://etherscan.io/address/0xdac17f958d2ee523a2206206994597c13d831ec7#code with no changes
*/

/**
 * Give receiver a small amount of base token for gas
 * Based on FundingRules in https://github.com/thundercore/thunder_bridge/blob/master/contracts/contracts/ERC677BridgeToken.sol
*/
contract Funded is Ownable {
    ...
    constructor() public {
        fundingRules.periodLength = 60 * 60 * 24;  // roughly every day on TT
        fundingRules.maxPeriodFunds = 100 * 1000000000000000000;  // 100 TT
        fundingRules.threshold = 10000000000000000;  // 0.01 TT
        fundingRules.amount = 10000000000000000;  // 0.01 TT
    }
...
// Mostly based on USDT https://etherscan.io/address/0xdac17f958d2ee523a2206206994597c13d831ec7#code

contract Token is Pausable, StandardToken, BlackList, Funded {
    ...
    // @param _to Who will receieve the issued token
    function issue(uint amount, address _to) public onlyOwner {
    ...
    event Issue(uint amount, address _to);
